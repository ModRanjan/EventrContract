...
pub fun main(address: Address, id: UInt64): NFT {
    ...
    let collectionRef = account.getCapability(Eventr1.CollectionPublicPath)
        .borrow<&{Eventr1.CollectionPublic}>()?? panic("Could not get CollectionPublic")

    let nft = collectionRef.borrowToken(id: id)?? panic("There is no such NFT in your account! Check your id")
