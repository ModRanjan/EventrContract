// testnet NFT standard contract for flow blockchain
// import NonFungibleToken from 0x631e88ae7f1d7c20
// Our own NFT standard contract for flow blockchain
...
pub contract Eventr: NonFungibleToken {
  ...
  init() {
    self.CollectionStoragePath = /storage/EventrNFTCollection
    self.CollectionPublicPath = /public/EventrNFTCollection
    self.CollectionPrivatePath= /private/EventrNFTCollection
    self.MinterStoragePath = /storage/EventrNFTMinter
    self.MinterPublicPath= /public/EventrNFTMinter
